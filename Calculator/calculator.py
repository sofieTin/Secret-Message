...
class Calculator:
    def __init__(self,master):
        ...
        self.entry_value=''
        Entry(root, width=17, bg='#ccddff', font=('Arial Bold', 28), textvariable=self.equation).place(x=0, y=0)
        ...
        Button(root, width=11, height=4, text='8', relief='flat', bg='white', command=lambda:self.show(8)).place(x=180, y=275)
        Button(root, width=11, height=4, text='9', relief='flat', bg='white', command=lambda:self.show(9)).place(x=90, y=275)
        ...
        Button(root, width=11, height=4, text='C', relief='flat', command=self.clear).place(x=0, y=350)
